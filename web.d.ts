...
declare namespace $ {
	...
	export class $bog_worm_slider extends $mol_view {
		least( ): number
		most( ): number
		step( ): number
		hint( ): string
		...
		attr( ): ({ 
			'type': string,
			'min': ReturnType< $bog_worm_slider['least'] >,
			'max': ReturnType< $bog_worm_slider['most'] >,
			'step': ReturnType< $bog_worm_slider['step'] >,
			'aria-label': ReturnType< $bog_worm_slider['hint'] >,
		})  & ReturnType< $mol_view['attr'] >
		field( ): ({ 
			'value': ReturnType< $bog_worm_slider['value_text'] >,
		})  & ReturnType< $mol_view['field'] >
		event( ): ({ 
			input( next?: ReturnType< $bog_worm_slider['event_change'] > ): ReturnType< $bog_worm_slider['event_change'] >,
		})  & ReturnType< $mol_view['event'] >
	}
...
declare namespace $ {
     ...
     */
    const $bog_worm_hue: Record<string, `#${string}`>;
}

declare namespace $ {

	type $mol_view__sub_bog_worm_panel_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_check_list__options_bog_worm_panel_2 = $mol_type_enforce<
		({ 
			'sensory': string,
			'poly': string,
			'inter': string,
	...
	>
	type $mol_check_list__option_checked_bog_worm_panel_3 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['type_on'] >
		,
		ReturnType< $mol_check_list['option_checked'] >
	>
	type $mol_view__sub_bog_worm_panel_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_panel_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_check_list__options_bog_worm_panel_6 = $mol_type_enforce<
		({ 
			'chemical': string,
			'gap': string,
		}) 
		...
		ReturnType< $mol_check_list['options'] >
	>
	type $mol_check_list__option_checked_bog_worm_panel_7 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['kind_on'] >
		,
		ReturnType< $mol_check_list['option_checked'] >
	>
	type $mol_view__sub_bog_worm_panel_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_panel_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_worm_slider__hint_bog_worm_panel_10 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_worm_slider['hint'] >
	>
	type $bog_worm_slider__least_bog_worm_panel_11 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_worm_slider['least'] >
	>
	type $bog_worm_slider__most_bog_worm_panel_12 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['weight_most'] >
		,
		ReturnType< $bog_worm_slider['most'] >
	>
	type $bog_worm_slider__value_bog_worm_panel_13 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['weight_min'] >
		,
		ReturnType< $bog_worm_slider['value'] >
	>
	type $mol_view__sub_bog_worm_panel_14 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_panel_15 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_search__hint_bog_worm_panel_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_search['hint'] >
	>
	type $mol_search__query_bog_worm_panel_17 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['path_from'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_search__suggests_bog_worm_panel_18 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['path_from_suggests'] >
		,
		ReturnType< $mol_search['suggests'] >
	>
	type $mol_search__hint_bog_worm_panel_19 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_search['hint'] >
	>
	type $mol_search__query_bog_worm_panel_20 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['path_to'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_search__suggests_bog_worm_panel_21 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['path_to_suggests'] >
		,
		ReturnType< $mol_search['suggests'] >
	>
	type $mol_view__sub_bog_worm_panel_22 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_panel_23 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_panel_24 = $mol_type_enforce<
		ReturnType< $bog_worm_panel['legend'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__attr_bog_worm_panel_25 = $mol_type_enforce<
		({ 
			'worm_type': ReturnType< $bog_worm_panel['legend_type'] >,
		})  & ReturnType< $mol_view['attr'] >
		,
		ReturnType< $mol_view['attr'] >
	>
	type $mol_view__sub_bog_worm_panel_26 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_worm_panel extends $mol_view {
		cells_title( ): string
		Cells_title( ): $mol_view
		type_on( id: any, next?: boolean ): boolean
		Types( ): $mol_check_list
		Cells( ): $mol_view
		links_title( ): string
		Links_title( ): $mol_view
		kind_on( id: any, next?: boolean ): boolean
		Kinds( ): $mol_check_list
		Links( ): $mol_view
		weight_title( ): string
		Weight_title( ): $mol_view
		weight_most( ): number
		weight_min( next?: number ): number
		Weight_slider( ): $bog_worm_slider
		Weight( ): $mol_view
		path_title( ): string
		Path_title( ): $mol_view
		path_from( next?: string ): string
		path_from_suggests( ): readonly(string)[]
		Path_from( ): $mol_search
		path_to( next?: string ): string
		path_to_suggests( ): readonly(string)[]
		Path_to( ): $mol_search
		path_note( ): string
		Path_note( ): $mol_view
		Path( ): $mol_view
		legend( ): readonly(any)[]
		Legend( ): $mol_view
		legend_type( id: any): string
		Legend_dot( id: any): $mol_view
		legend_label( id: any): string
		sub( ): readonly(any)[]
		Legend_row( id: any): $mol_view
	}
...
declare namespace $.$$ {
    ...
    class $bog_worm_panel extends $.$bog_worm_panel {
        weight_title(): string;
        path_from_suggests(): string[];
        path_to_suggests(): string[];
        legend(): $mol_view[];
        legend_type(type: string): string;
        legend_label(type: string): string;
    }
}
...
declare namespace $ {
	...
	export class $bog_worm_plot extends $mol_canvas {
		grabbing( ): boolean
		event_down( next?: any ): any
		event_move( next?: any ): any
		event_up( next?: any ): any
		event_off( next?: any ): any
		...
		weight_min( ): number
		focus( next?: string ): string
		path_from( ): string
		path_to( ): string
		hover( next?: string ): string
		picked( next?: number ): number
		tip( ): string
		tip_x( next?: number ): number
		tip_y( next?: number ): number
		reset( next?: any ): any
		attr( ): ({ 
			'tabindex': number,
			'worm_grabbing': ReturnType< $bog_worm_plot['grabbing'] >,
		})  & ReturnType< $mol_canvas['attr'] >
		event( ): ({ 
			pointerdown( next?: ReturnType< $bog_worm_plot['event_down'] > ): ReturnType< $bog_worm_plot['event_down'] >,
			pointermove( next?: ReturnType< $bog_worm_plot['event_move'] > ): ReturnType< $bog_worm_plot['event_move'] >,
			pointerup( next?: ReturnType< $bog_worm_plot['event_up'] > ): ReturnType< $bog_worm_plot['event_up'] >,
			pointercancel( next?: ReturnType< $bog_worm_plot['event_off'] > ): ReturnType< $bog_worm_plot['event_off'] >,
			pointerleave( next?: ReturnType< $bog_worm_plot['event_leave'] > ): ReturnType< $bog_worm_plot['event_leave'] >,
			wheel( next?: ReturnType< $bog_worm_plot['event_wheel'] > ): ReturnType< $bog_worm_plot['event_wheel'] >,
		})  & ReturnType< $mol_canvas['event'] >
	}
...
declare namespace $.$$ {
    ...
    export class $bog_worm_plot extends $.$bog_worm_plot {
        ...
        center(next?: readonly number[]): readonly number[];
        reset(): void;
        ...
        device(client_x: number, client_y: number): number[];
        world(client_x: number, client_y: number): number[];
        layout(): $bog_worm_layout;
        visible(): Uint8Array<ArrayBuffer>;
        drawn(): $bog_worm_edge[];
        /** A focus key is either a cell name or a class name, so "ASH" lights up both ASHL and ASHR. */
        focus_cells(): number[];
        path_chains(): number[][];
        path_ends(key: string): number[];
        ...
        paint(): void;
        paint_labels(context: CanvasRenderingContext2D, paint: Palette, ratio: number, at_x: (index: number) => number, at_y: (index: number) => number): void;
        /** Uniform grid over the layout, so hover does not scan four hundred cells on every mouse move. */
        grid(): {
            side: number;
            buckets: number[][];
        };
        cell_at(wx: number, wy: number): number;
        edge_at(wx: number, wy: number): number;
        pointers: Map<number, {
            x: number;
            y: number;
            at: number;
        ...
        grabbing(next?: boolean): boolean;
        event_down(event?: PointerEvent): null;
        event_move(event?: PointerEvent): null;
        pinch_span: number;
        pinch(): void;
        event_up(event?: PointerEvent): null;
        event_off(event?: PointerEvent): null;
        event_leave(event?: PointerEvent): null;
        event_wheel(event?: WheelEvent): null;
        zoom_at(client_x: number, client_y: number, factor: number): void;
        hover_at(client_x: number, client_y: number): void;
        tap(client_x: number, client_y: number): void;
        tip(): string;
    }
    export {};
}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_worm_detail_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_detail_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__hint_bog_worm_detail_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_worm_detail_4 = $mol_type_enforce<
		ReturnType< $bog_worm_detail['close'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_worm_detail_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub_bog_worm_detail_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_bog_worm_detail_7 = $mol_type_enforce<
		ReturnType< $bog_worm_detail['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_worm_detail_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_detail_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_detail_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_detail_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click_bog_worm_detail_12 = $mol_type_enforce<
		ReturnType< $bog_worm_detail['row_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_worm_detail_13 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	export class $bog_worm_detail extends $mol_view {
		name( ): string
		Name( ): $mol_view
		facts( ): string
		Facts( ): $mol_view
		...
		row_click( id: any, next?: any ): any
		row_peer( id: any): string
		Row_peer( id: any): $mol_view
		row_note( id: any): string
		Row_note( id: any): $mol_view
		row_weight( id: any): string
		Row_weight( id: any): $mol_view
		focus( next?: string ): string
		sub( ): readonly(any)[]
		Section( id: any): $mol_view
...
declare namespace $.$$ {
    ...
    export class $bog_worm_detail extends $.$bog_worm_detail {
        ...
        link_index(): Map<string, Link>;
        rows(): $mol_view[];
        section_title(key: string): string;
        row_peer(key: string): string;
        row_note(key: string): string;
        row_weight(key: string): string;
        row_click(key: string, next?: any): null;
        close(next?: any): null;
    }
    export {};
}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_worm_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_search__hint_bog_worm_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_search['hint'] >
	>
	type $mol_search__query_bog_worm_4 = $mol_type_enforce<
		ReturnType< $bog_worm['query'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_search__suggests_bog_worm_5 = $mol_type_enforce<
		ReturnType< $bog_worm['suggests'] >
		,
		ReturnType< $mol_search['suggests'] >
	>
	type $mol_select__hint_bog_worm_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_select['hint'] >
	>
	type $mol_select__value_bog_worm_7 = $mol_type_enforce<
		ReturnType< $bog_worm['layout_name'] >
		,
		ReturnType< $mol_select['value'] >
	>
	type $mol_select__dictionary_bog_worm_8 = $mol_type_enforce<
		({ 
			'layered': string,
			'force': string,
		}) 
	...
	>
	type $mol_button_minor__hint_bog_worm_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_worm_10 = $mol_type_enforce<
		ReturnType< $bog_worm['reset'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_worm_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_check__title_bog_worm_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check['title'] >
	>
	type $mol_check__hint_bog_worm_13 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check['hint'] >
	>
	type $mol_check__checked_bog_worm_14 = $mol_type_enforce<
		ReturnType< $bog_worm['panel_showed'] >
		,
		ReturnType< $mol_check['checked'] >
	>
	type $mol_view__dom_name_bog_worm_15 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub_bog_worm_16 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_worm_17 = $mol_type_enforce<
		ReturnType< $bog_worm['stage'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_link__uri_bog_worm_18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__external_bog_worm_19 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_link['external'] >
	>
	type $mol_link__title_bog_worm_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link__uri_bog_worm_21 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__external_bog_worm_22 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_link['external'] >
	>
	type $mol_link__title_bog_worm_23 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link__uri_bog_worm_24 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__external_bog_worm_25 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_link['external'] >
	>
	type $mol_link__title_bog_worm_26 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link__uri_bog_worm_27 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__external_bog_worm_28 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_link['external'] >
	>
	type $mol_link__title_bog_worm_29 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_view__dom_name_bog_worm_30 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub_bog_worm_31 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_worm_panel__type_on_bog_worm_32 = $mol_type_enforce<
		ReturnType< $bog_worm['type_on'] >
		,
		ReturnType< $bog_worm_panel['type_on'] >
	>
	type $bog_worm_panel__kind_on_bog_worm_33 = $mol_type_enforce<
		ReturnType< $bog_worm['kind_on'] >
		,
		ReturnType< $bog_worm_panel['kind_on'] >
	>
	type $bog_worm_panel__weight_min_bog_worm_34 = $mol_type_enforce<
		ReturnType< $bog_worm['weight_min'] >
		,
		ReturnType< $bog_worm_panel['weight_min'] >
	>
	type $bog_worm_panel__path_from_bog_worm_35 = $mol_type_enforce<
		ReturnType< $bog_worm['path_from'] >
		,
		ReturnType< $bog_worm_panel['path_from'] >
	>
	type $bog_worm_panel__path_to_bog_worm_36 = $mol_type_enforce<
		ReturnType< $bog_worm['path_to'] >
		,
		ReturnType< $bog_worm_panel['path_to'] >
	>
	type $mol_view__sub_bog_worm_37 = $mol_type_enforce<
		ReturnType< $bog_worm['board'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_worm_plot__layout_name_bog_worm_38 = $mol_type_enforce<
		ReturnType< $bog_worm['layout_name'] >
		,
		ReturnType< $bog_worm_plot['layout_name'] >
	>
	type $bog_worm_plot__types_bog_worm_39 = $mol_type_enforce<
		ReturnType< $bog_worm['types'] >
		,
		ReturnType< $bog_worm_plot['types'] >
	>
	type $bog_worm_plot__kinds_bog_worm_40 = $mol_type_enforce<
		ReturnType< $bog_worm['kinds'] >
		,
		ReturnType< $bog_worm_plot['kinds'] >
	>
	type $bog_worm_plot__weight_min_bog_worm_41 = $mol_type_enforce<
		ReturnType< $bog_worm['weight_min'] >
		,
		ReturnType< $bog_worm_plot['weight_min'] >
	>
	type $bog_worm_plot__focus_bog_worm_42 = $mol_type_enforce<
		ReturnType< $bog_worm['focus'] >
		,
		ReturnType< $bog_worm_plot['focus'] >
	>
	type $bog_worm_plot__path_from_bog_worm_43 = $mol_type_enforce<
		ReturnType< $bog_worm['path_from'] >
		,
		ReturnType< $bog_worm_plot['path_from'] >
	>
	type $bog_worm_plot__path_to_bog_worm_44 = $mol_type_enforce<
		ReturnType< $bog_worm['path_to'] >
		,
		ReturnType< $bog_worm_plot['path_to'] >
	>
	type $mol_view__style_bog_worm_45 = $mol_type_enforce<
		({ 
			'left': ReturnType< $bog_worm['tip_left'] >,
			'top': ReturnType< $bog_worm['tip_top'] >,
		}) 
		,
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__sub_bog_worm_46 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_worm_detail__focus_bog_worm_47 = $mol_type_enforce<
		ReturnType< $bog_worm['focus'] >
		,
		ReturnType< $bog_worm_detail['focus'] >
	>
	export class $bog_worm extends $mol_view {
		panel_state( ): string
		layout_kind( ): string
		...
		suggests( ): readonly(string)[]
		Search( ): $mol_search
		layout_name( next?: string ): string
		Layout( ): $mol_select
		reset( next?: any ): any
		reset_label( ): string
		Reset( ): $mol_button_minor
		panel_showed( next?: boolean ): boolean
		Panel_toggle( ): $mol_check
		Head( ): $mol_view
		stage( ): readonly(any)[]
		Stage( ): $mol_view
		foot_lead( ): string
		...
		hint( ): string
		attr( ): ({ 
			'worm_panel': ReturnType< $bog_worm['panel_state'] >,
			'worm_layout': ReturnType< $bog_worm['layout_kind'] >,
		})  & ReturnType< $mol_view['attr'] >
		plugins( ): readonly(any)[]
		auto( ): readonly(any)[]
		sub( ): readonly(any)[]
		Aside( ): $bog_worm_panel
		Board( ): $mol_view
		Canvas( ): $bog_worm_plot
		Tip( ): $mol_view
		Links( ): $bog_worm_detail
	}
	
}

//# sourceMappingURL=worm.view.tree.d.ts.map
declare namespace $.$$ {
    /**
    ...
    class $bog_worm extends $.$bog_worm {
        arg(key: string, next?: string): string;
        focus(next?: string): string;
        path_from(next?: string): string;
        path_to(next?: string): string;
        layout_name(next?: string): string;
        ...
        off(key: string, name: string, next?: boolean): boolean;
        type_on(type: string, next?: boolean): boolean;
        kind_on(kind: string, next?: boolean): boolean;
        types(): Record<string, boolean>;
        kinds(): Record<string, boolean>;
        count(): string;
        query_text(next?: string): string;
        /** Typing or picking a full name — a cell like ASHL or a class like ASH — selects it right away. */
        query(next?: string): string;
        suggests(): string[];
        reset(next?: any): null;
        escape(next?: any): null;
        /** Narrow enough that the side panels have to float above the canvas instead of beside it. */
        layout_kind(): "narrow" | "wide";
        panel_showed(next?: boolean): boolean;
        panel_state(): "on" | "off";
        stage(): ($mol_view | $.$bog_worm_panel | $.$bog_worm_detail)[];
        board(): $mol_view[];
        tip_text(): string;
        tip_left(): string;
        tip_top(): string;
        auto(): $mol_dom_listener[];
        keyboard(): $mol_dom_listener;
...
declare namespace $ {
    type $bog_worm_kind = 'chemical' | 'gap';
    type $bog_worm_type = 'sensory' | 'inter' | 'motor' | 'poly' | 'unknown' | 'muscle' | 'other';
    type $bog_worm_edge = {
    ...
    class $bog_worm_graph extends $mol_object2 {
        ...
        static model(): {
            cells: readonly $bog_worm_cell[];
            edges: readonly $bog_worm_edge[];
            index: Map<string, $bog_worm_cell>;
            weight_max: number;
        };
        static cells(): readonly $bog_worm_cell[];
        static edges(): readonly $bog_worm_edge[];
        static index(): Map<string, $bog_worm_cell>;
        static cell(id: string): $bog_worm_cell | null;
        /** Heaviest edge weight, for scaling line widths. */
        static weight_max(): number;
        /** Every name the user may search for: cell names and class names alike. */
        static names(): string[];
        static suggest(query: string, limit?: number): string[];
         ...
         */
        static paths(from: number, to: number, limit?: number, hops?: number): number[][];
        /** Breadth first hop counts from a cell, -1 where unreachable within `hops`. */
        static distances(start: number, hops: number, step: (cell: $bog_worm_cell) => number[]): Int16Array<ArrayBuffer>;
    }
}
